...
def products_dev(sparkSession: SparkSession) -> DataFrame:
    ...
    data = [
        ...
        ("P002", "Bluetooth Keyboard", "Electronics", 49.99),
        ("P003", "USB-C Cable", "Electronics", 19.99),
        ("P004", "Laptop Stand", "Electronics", 99.99),
        ("P005", "Webcam HD", "Electronics", 79.99),
        # Home & Kitchen
        ("P006", "Coffee Maker", "Home & Kitchen", 89.99),
        ("P007", "Blender Pro", "Home & Kitchen", 129.99),
        ("P008", "Air Fryer", "Home & Kitchen", 149.99),
        ("P009", "Toaster", "Home & Kitchen", 39.99),
        ("P010", "Water Filter", "Home & Kitchen", 59.99),
        # Books
        ("P011", "Python Programming", "Books", 45.99),
        ("P012", "Data Science Handbook", "Books", 54.99),
        ("P013", "Cloud Architecture", "Books", 39.99),
        ("P014", "Machine Learning Basics", "Books", 49.99),
        ("P015", "Web Development Guide", "Books", 42.99),
    ]
